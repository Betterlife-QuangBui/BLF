...
//    $(".item-of-page").each(function (i, e) {
//        $(this).find(".box-item").removeClass("active-item");
//    });
...
function inputSearch(key) {
    if ($(key).val().toString().length>2){
        $(".item-of-page").html("");
        $(".item-of-page").load('/Ajax/ExportGood?page=1&key=' + $(key).val());
    }
