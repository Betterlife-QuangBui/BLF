...
$(document).on("click", "#storejp-table .storejp-pagging-index a", function (e) {
    ...
    var namejp = $("#storejp-table thead tr input:eq(1)").val();
    var nameen = $("#storejp-table thead tr input:eq(2)").val();

    if (href === undefined || href === null) { }
    else {
        $("#storejp-table tbody").html("");
        href = href + "&name=" + name + "&namejp=" + namejp + "&nameen=" + nameen + "&data_sort=" + data_sort;
...
$(document).on("click", "#storejp-table .sort-row .sort", function (e) {
    ...
    var href = "/WareHouseCategory/AjaxIndex?page=1" + "&name=" + name + "&namejp=" + namejp + "&nameen=" + nameen + "&data_sort=" + data_sort;
