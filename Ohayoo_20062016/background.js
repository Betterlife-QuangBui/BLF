...
var Notify = {
    ...
    /**
     * @description HĂ m táº¡o láº¥y dá»¯ liá»‡u Ä‘á»“ng bá»™ vá»›i server vĂ  lÆ°u dá»¯ liá»‡u xuá»‘ng localStorage
     * @author vanhs
    ...
    getListNotify: function(){
        ...
        Common.request({
            ...
            //Náº¿u logout khi request ajax bá»‹ redirect vá» Ä‘á»‹a chá»‰ http://beta.ohayoo.vn/customer/i/
            user_id = null;
            Notify.clearDataWhenChangeUser();
        });
    },
    ...
    /**
     * @description HĂ m táº¡o notify chrome desktop theo tá»•ng sá»‘ thĂ´ng bĂ¡o chÆ°a Ä‘á»c
     * @author vanhs
     * @time 08:53 21/12/2015
    ...
    createNotifyGroup: function(totalUnreadNotify){
        ...
        if(totalUnreadNotify > number_group_notify){
            ...
            var option = {
                ...
                title: "",
                message: "Báº¡n cĂ³ " + totalUnreadNotify + " thĂ´ng bĂ¡o má»›i",
                priority: 0
            };
    ...
    /**
     * @description HĂ m táº¡o notify chrome desktop theo tá»«ng thĂ´ng bĂ¡o chÆ°a Ä‘á»c
     * @author vanhs
     * @time 08:53 21/12/2015
     * @param item
     */
    ...
    /**
     * @description HĂ m render icon theo tá»«ng loáº¡i thĂ´ng bĂ¡o riĂªng biá»‡t
     * @author vanhs
     * @time 08:53 21/12/2015
     * @param businessType
     * @returns {string}
    ...
    /**
     * @description Khi thay Ä‘á»•i user login thĂ¬ xĂ³a toĂ n bá»™ dá»¯ liá»‡u cá»§a user trÆ°á»›c Ä‘Ă³ Ä‘i
     * @author vanhs
     * @returns {boolean}
     */
    ...
    getIconWebservice: function(service){
        ...
        if(service){
            switch (service.toUpperCase()){
                case 'OHAYOO':
                    iconUrl = 'images/add_on/notify/logoOhayoo.png';
                    break;
                case 'ORDERHANG':
...
Notify.clearDataWhenChangeUser();
Notify.getListNotify();//Chá»‰ cháº¡y láº§n Ä‘áº§u tiĂªn
