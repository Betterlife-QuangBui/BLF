...
var CommonTool = function () {
  ...
  this.addProToCart = function (data) {
    ...
    if (flagShop == false) {
      var tbShops = []
      tbShops.push(data)
      var jsonShop = {'key': shop_id,'shop_name': data.shop_name,'shop_url': data.shop_url,'time': getDateTime(),'sum_quantity': data.quantity,'sum_yen': data.yen,'sum_vnd': data.vnd,'value': tbShops}
